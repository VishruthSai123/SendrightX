...
open class KeyboardState protected constructor(open var rawValue: ULong) {
    companion object {
        ...
        const val F_IS_TRANSLATION_PANEL_VISIBLE: ULong =  0x00100000u
        const val F_IS_COMPOSING_ENABLED: ULong =           0x00200000u
    ...
    var isTranslationPanelVisible: Boolean
        get() = getFlag(F_IS_TRANSLATION_PANEL_VISIBLE)
        set(v) { setFlag(F_IS_TRANSLATION_PANEL_VISIBLE, v) }
