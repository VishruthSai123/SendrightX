...
"""generate_spellcheck_config.py: Simple helper script for auto generating the spell check config
   ...
   keyboard subtype, and Android ignores the SendRight spell checker unless it declares the currently active system
...
PULL_CMD_INPUT = """run-as com.vishruth.sendright.debug
...
<spell-checker xmlns:android="http://schemas.android.com/apk/res/android"
    android:label="@string/sendright_app_name"
    android:settingsActivity="com.vishruth.sendright.SettingsLauncherAlias">
"""
